...
<head>
	...
	<title>Salvando Patitas | Ver Institución</title>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            <h1 class="text-white" style="margin-top: -40px;">Forma parte de esta institución</h1>
            <p class="lead mb-4 mt-4 text-white opacity-8">A continuación, podrás visualizar la información de la institución que seleccionaste</p>
