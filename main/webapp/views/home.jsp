...
<head>
	...
	<title>Salvando Patitas | Bienvenido</title>
...
<body class="g-sidenav-show bg-gray-200">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark">Principal</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Mascotas</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Mascotas</h6>
        </nav>
       ...
       <c:forEach items="${mascotas}" var="mascota">
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card z-index-2 ">
            ...
            <div class="card-body">
              <h6 class="mb-0">${mascota.nombreMascota}</h6>
              <span class="text-sm">${mascota.tipoMascota}</span><span> / </span><span class="text-sm">${mascota.ubicacion}</span>
              <hr class="dark horizontal">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <a class="btn bg-gradient-warning mt-1 mb-1 col-4 w-100" href="mascota?action=ver&idMascota=${mascota.idMascota}" role="button" type="button">Ver más</a>
                        <c:if test="${user.rol.equals('admin')}">
							<a class="btn bg-gradient-success mt-1 mb-1 col-4 w-100" href="mascota?action=ver&idMascota=${mascota.idMascota}" role="button" type="button">Actualizar</a>
							<a class="btn bg-gradient-primary mt-1 mb-1 col-4 w-100" href="mascota?action=eliminar&idMascota=${mascota.idMascota}" role="button" onclick="return confirm('Se va a proceder a la eliminación de la mascota ${mascota.nombreMascota}. ¿Desea continuar?')" type="button">Eliminar</a>
						</c:if>
                    </div>
                </div>
            </div>
  ...
  <div class="fixed-plugin">
    <form  method="post" action="../views/mascota">
	 <button type="submit" class="fixed-plugin-button-2 text-dark position-fixed px-3 py-2" value="addMascota" style="border: none;" name="action">
  ...
  <script src="../js/dashboard/material-dashboard.min.js?v=3.0.0"></script>
</body>
</html>